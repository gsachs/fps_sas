...
import { createImpactSystem, shooterIdsThatHit } from '../../src/render/impacts.js';
...
describe('createImpactSystem', () => {
  ...
  // Four bots firing ~10 shots/second each would grow an unbounded pool for
  // the length of a match, which is exactly what the memory-plateau bar rules
  // out.
